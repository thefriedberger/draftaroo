const PlayerListSkeleton = () => {
   return (
      <div className="flex flex-col justify-between min-h-full w-full lg:border-r lg:border-paper-dark dark:lg:border-gray-300">
         <div className="grid grid-cols-3 lg:gap-1 lg:grid-cols-5 min-h-10 lg:min-h-7">
         ...
         <div className="grid grid-cols-7 lg:grid-cols-12 gap-2 bg-gold px-3 py-2 min-h-9 lg:min-h-7">
            <div></div>
         ...
         {Array.from({ length: 50 }).map((v, i) => {
            return (
               ...
               >
                  <div className="w-full h-full grid grid-cols-7 lg:grid-cols-12 gap-2">
                     <div></div>
                     <div className="h-full w-full col-span-2 bg-paper-dark dark:bg-gray-primary rounded-md animate-pulse"></div>
                     <div></div>
                     <div className="h-full w-full bg-paper-dark dark:bg-gray-primary rounded-md animate-pulse"></div>
                     <div className="h-full w-full bg-paper-dark dark:bg-gray-primary rounded-md animate-pulse"></div>
                     <div className="h-full w-full bg-paper-dark dark:bg-gray-primary rounded-md animate-pulse"></div>
                     <div className="hidden lg:block h-full w-full bg-paper-dark dark:bg-gray-primary rounded-md animate-pulse"></div>
                     <div className="hidden lg:block h-full w-full bg-paper-dark dark:bg-gray-primary rounded-md animate-pulse"></div>
                     <div className="hidden lg:block h-full w-full bg-paper-dark dark:bg-gray-primary rounded-md animate-pulse"></div>
                     <div className="hidden lg:block h-full w-full bg-paper-dark dark:bg-gray-primary rounded-md animate-pulse"></div>
                     <div className="hidden lg:block h-full w-full bg-paper-dark dark:bg-gray-primary rounded-md animate-pulse"></div>
